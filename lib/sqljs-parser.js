  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "INDEX_COL_NAME_LIST": parse_INDEX_COL_NAME_LIST,
        "INDEX_COL_NAME": parse_INDEX_COL_NAME,
                  ...
                  if (result3 !== null) {
                    ...
                    if (result4 !== null) {
                      ...
                      if (result5 !== null) {
                        result6 = parse__();
                        if (result6 !== null) {
                          result7 = parse_INDEX_COL_NAME_LIST();
                          if (result7 !== null) {
                            if (input.charCodeAt(pos) === 41) {
                              result8 = ")";
                              pos++;
                  ...
                  if (result2 !== null) {
                    ...
                    if (result3 !== null) {
                      ...
                      if (result4 !== null) {
                        result5 = parse__();
                        if (result5 !== null) {
                          result6 = parse_INDEX_COL_NAME_LIST();
                          if (result6 !== null) {
                            if (input.charCodeAt(pos) === 41) {
                              result7 = ")";
                              pos++;
      ...
      function parse_INDEX_COL_NAME_LIST() {
        var cacheKey = "INDEX_COL_NAME_LIST@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result3 !== null) {
              result3 = (function(offset, index_col_name2) { return index_col_name2; })(pos2, result3[2]);
            }
            if (result3 === null) {
              pos = pos2;
            }
        ...
        if (result0 !== null) {
          result0 = (function(offset, index_col_name, rest) { rest.unshift(index_col_name); return rest; })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_INDEX_COL_NAME() {
        var cacheKey = "INDEX_COL_NAME@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result0 !== null) {
          result0 = (function(offset, id, length) {
            var key = {
              id: id,
            }
            if(length)
                        ...
                        if (result0 === null) {
                          ...
                          if (result0 === null) {
                            ...
                            if (result0 === null) {
                              ...
                              result0 = parse__();
                              if (result0 !== null) {
                                if (input.substr(pos, 7).toLowerCase() === "boolean") {
                                  result1 = input.substr(pos, 7);
                                  pos += 7;
                                } else {
                                  result1 = null;
