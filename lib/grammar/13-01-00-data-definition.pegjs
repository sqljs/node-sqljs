...
CREATE_DATABASE "CREATE DATABASE"
  = "CREATE"i __ "DATABASE"i __ name:ID props:SCHEMA_PROPERTIES {
...
SCHEMA_PROPERTIES "schema properties"
  = __ ("DEFAULT"i __)? "CHAR"i "ACTER"i? (_/"_") "SET"i (_ "=" _ / __) charset:ID props:SCHEMA_PROPERTIES {
      props.charset = charset;
      return props;
    }
  / __ ("DEFAULT"i __)? "COLLAT"i ("E"i/"ION"i) (_ "=" _ / __) collate:ID props:SCHEMA_PROPERTIES {
      props.collate = collate;
      return props;
    }
  / __ "COMMENT"i (_ "=" _ / __) comment:(ID/STRING) props:SCHEMA_PROPERTIES {
...
COLUMN_DEFINITION "Column definition"
  = name:ID props:COLUMN_TYPE_PROPERTIES { props.name = name; return props; }
